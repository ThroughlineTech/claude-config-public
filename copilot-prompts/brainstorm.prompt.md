...
**Before starting the session, read `~/.claude/brainstorm-mode.md`** (loaded globally via `brainstorm-mode.instructions.md`). The rules there are not optional: capture over convergence, no code, no implementation plans, user signals the end.
