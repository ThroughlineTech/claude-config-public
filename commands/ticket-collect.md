...
After another agent (e.g. Gemini in Copilot) executes a brief generated by `/ticket-delegate`, this command verifies the work came back as expected and transitions the ticket to the next status.
